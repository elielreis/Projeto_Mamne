def GUI_TETRA(context):
    ...
    class APP_MODAL_TETRA(QDialog):
            ...
            if objId:
                ...
                if mesh:
                    ...
                    self.connec_volume = array(
                        [self.mesh.GetElemNodes(i) for i in volume_id], int) - 1
        ...
        def compute_click(self, Ux, Uy, Uz, E, nu, rho, k):
            ...
            self.MODOS = MODAL_TETRA(self.coord, self.connec_volume, self.nodesr,
                                   self.E, self.nu, self.rho, self.gr, self.k)
        ...
        def save_vtk(self, modei, scale):
            ...
            vtk = pyvtk.VtkData(pyvtk.UnstructuredGrid (U, tetra=connec_volume),
